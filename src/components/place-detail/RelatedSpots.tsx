...
const RelatedSpots = ({ places, onPlaceClick }: RelatedSpotsProps) => {
  ...
  return (
    <div className="space-y-3 animate-fade-in group/related" style={{ animationDelay: '0.3s' }}>
      ...
      <div className="relative">
        ...
        {showLeftArrow && (
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 hidden md:flex items-center justify-center w-8 h-8 bg-card/95 backdrop-blur-sm rounded-full shadow-lg border border-border opacity-0 group-hover/related:opacity-100 transition-opacity duration-200 hover:bg-card"
          >
        ...
        {showRightArrow && (
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 hidden md:flex items-center justify-center w-8 h-8 bg-card/95 backdrop-blur-sm rounded-full shadow-lg border border-border opacity-0 group-hover/related:opacity-100 transition-opacity duration-200 hover:bg-card"
          >
