  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={handleSave}
          className={`absolute top-2.5 right-2.5 w-8 h-8 flex items-center justify-center bg-card/90 backdrop-blur-sm rounded-full transition-all duration-200 hover:scale-110 ${
