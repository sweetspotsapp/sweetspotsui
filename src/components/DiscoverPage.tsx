      ...
      <div className="sticky top-0 lg:top-16 z-30 bg-background/95 backdrop-blur-sm border-b border-border/50 lg:border-b-0">
        <div className="flex items-center justify-between px-4 lg:px-8 py-0">
          ...
          <div className="flex flex-col items-center gap-0 lg:hidden">
            <h1 className="text-xl font-bold text-primary tracking-tight leading-none" style={{ fontFamily: "'Inter', sans-serif" }}>Discover</h1>
            <button onClick={() => setIsLocationPickerOpen(true)} className="-mt-0.5 flex items-center gap-1 text-xs leading-none text-muted-foreground hover:text-primary transition-colors">
