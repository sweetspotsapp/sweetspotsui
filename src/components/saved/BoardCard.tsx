          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                ...
                className="absolute top-2 right-2 h-7 min-w-11 px-3.5 inline-flex items-center justify-center rounded-full bg-black/40 backdrop-blur-sm sm:h-8 sm:min-w-12 sm:px-4
